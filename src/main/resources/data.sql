...
INSERT INTO surgeries(surgery_id, name, address, phone) VALUES
('S10', 'Surgery 10', '10 Main Street', '555-0010'),
('S13', 'Surgery 13', '13 Main Street', '555-0013'),
('S15', 'Surgery 15', '15 Main Street', '555-0015');


INSERT INTO patients(patient_id, first_name, last_name, phone, email, address, dob, has_unpaid_bill) VALUES
...
INSERT INTO dentists(dentist_id, first_name, last_name, phone, email, specialization) VALUES
...
INSERT INTO appointments(appointment_id, date, time, status, dentist_dentist_id, patient_patient_id, surgery_surgery_id) VALUES
